...
class Invitation(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    start_user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=False)
    end_user_id = db.Column(db.Integer, db.ForeignKey("users.id"), nullable=False)
    channel_id = db.Column(db.Integer, db.ForeignKey("channels.id"), nullable=False)
    flag_active = db.Column(db.Boolean, nullable=False)
    flag_direction = db.Column(db.Boolean, nullable=False)
